...
VSOutput main(VSInput input) {
    ...
    float index = input.gridPos.x + input.gridPos.y;
    ...
    float2 lightUV = (input.gridPos + 0.5) / float2(boardWidth, boardHeight);
    output.gridPos = lightUV;
