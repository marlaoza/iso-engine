...
//             int c = 0;
//             for(SDL_Point n : neighbors){
//                 if(highlightRegionMap[l].find(n) == highlightRegionMap[l].end()){
//                     edges |= (1 << c);
//                 }
//                 c++;
//             }
                            
//             vertices.push_back({body.surface[0], {0.0f, 0.0f}, l, p.x, p.y});
//             vertices.push_back({body.surface[1], {1.0f, 0.0f}, l, p.x, p.y});
//             vertices.push_back({body.surface[2], {0.0f, 1.0f}, l, p.x, p.y});
//             vertices.push_back({body.surface[3], {1.0f, 1.0f}, l, p.x, p.y});
