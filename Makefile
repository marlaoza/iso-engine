...
EFFECTS = src/engine/effects/highlight/highlight.cpp src/engine/effects/particle/particle.cpp src/engine/effects/lightSource/lightSource.cpp 
ENGINE = src/engine/map/map.cpp src/engine/geometry/geometry.cpp src/engine/render/render.cpp src/engine/render/renderLayer/renderLayer.cpp src/engine/ui/ui.cpp src/engine/sprite/sprite.cpp 
